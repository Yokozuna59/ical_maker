...
# months = {"January":"1", "February":"2", "March":"3", "April":"4", "May":"5", "June":"6", "July":"7", "August":"8", "Sepember":"9", "October":"10", "November":"11", "December":"12", }
                              ...
                              for i in range_table:
                                   ...
                                   for j in range_splitted_lines:
                                        ...
                                        if (length_splitted == 11):
                                             date_item = " ".join(splitted_items[5].split())
                                             event_item = " ".join(splitted_items[8].split())
                                        elif (length_splitted == 13):
                                             date_item = " ".join(splitted_items[7].split())
